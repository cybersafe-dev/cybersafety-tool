        ...
        <section className="section-container">
          <div id="tool">
            <div className="section">
              ...
              <ReactMarkdown className="site-text" children={data.minisitecontent.tool} />
            </div>
          ...
          <div id="awards">
            <div className="section">
              ...
              <ReactMarkdown className="site-text" children={data.minisitecontent.awards} />
            </div>
          ...
          <div id="levels">
            <div className="section">
              ...
              <ReactMarkdown className="site-text" children={data.minisitecontent.levels} />
            </div>
            </div>
            ...
            <div id="pricing">
              <div className="section">
                ...
                <ReactMarkdown className="site-text" children={data.minisitecontent.pricing} />
              </div>
            </div>
          <div id="about">
            <div className="section">
              <h1 className="section-title">About us: <span className="italics">Who are we?</span></h1>
              <ReactMarkdown className="site-text" children={data.minisitecontent.aboutus} />
            </div>
